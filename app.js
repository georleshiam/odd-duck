...
let randomPicture2= document.querySelector('#Image2')
randomPicture2.setAttribute('src',randomProduct2.imagePath)

let randomProduct3= imagesArray[image3]
let randomPicture3= document.querySelector('#Image3')
randomPicture3.setAttribute('src',randomProduct3.imagePath)
